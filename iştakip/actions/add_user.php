...
if(!empty($_POST['username']) && !empty($_POST['name']) && !empty($_POST['lastname']) && !empty($_POST['email']) && !empty($_POST['phone']))
{
    ...
    $query="INSERT INTO users (username,user_firstname,user_lastname,user_email,user_phone,user_password,user_role,added_date) ";
    $query.="VALUES('{$username}','{$name}','{$lastname}','{$email}','{$phone}','{$password}','0',now())";
      ...
      <div class="row">
        ...
        <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../actions/add_user.php" method="post">
